    ...
    return (
        ...
        >
            ...
            <View style={styles.formContainer}>
                ...
                <Text style={styles.buttonText}>No account yet? <TouchableOpacity onPress={() => router.replace("/auth/signupScreen")} ><Text className="text-[#9B5DC8] text-[16px] relative top-1">Create an account</Text></TouchableOpacity></Text>
